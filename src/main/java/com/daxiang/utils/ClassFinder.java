...
//      return getClasses(new File(url.getFile()), pk);  
    ...
    public static void getClassFromJar() throws IOException {
        JarFile jarFile = new JarFile(new File("target/api-0.0.2-SNAPSHOT-shaded.jar"));
        Enumeration jarEntries = jarFile.entries();
        while (jarEntries.hasMoreElements()) {
            JarEntry jarEntry = (JarEntry) jarEntries.nextElement();
            System.out.println(jarEntry.getName().toString());
        }
    }
